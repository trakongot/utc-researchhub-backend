...
-- CreateEnum
CREATE TYPE "DraftTopicStatusT" AS ENUM ('PENDING_ADVISOR', 'REQUESTED_CHANGES_ADVISOR', 'REJECTED_BY_ADVISOR', 'ADVISOR_APPROVED', 'REQUESTED_CHANGES_HEAD', 'REJECTED_BY_HEAD', 'APPROVED_BY_HEAD');

-- CreateEnum
CREATE TYPE "ProposalStatusT" AS ENUM ('PENDING_REVIEW', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "TopicMemberStatus" AS ENUM ('PENDING', 'APPROVED', 'LOCKED');
...
-- CreateEnum
CREATE TYPE "ResultFileStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "DefenseCommitteeStatus" AS ENUM ('PREPARING', 'SCHEDULED', 'ONGOING', 'FINISHED');

-- CreateEnum
CREATE TYPE "DefenseCommitteeRoleT" AS ENUM ('CHAIRMAN', 'DEAN', 'SECRETARY', 'REVIEWER', 'MEMBER');

-- CreateEnum
CREATE TYPE "EvaluationStatusType" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED');
...
-- CreateTable
CREATE TABLE "LecturecPreferences" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "LecturecPreferences_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "StudentAdvisorPreferences" (
    "id" TEXT NOT NULL,
    "topic_title" TEXT NOT NULL,
    ...
    CONSTRAINT "StudentAdvisorPreferences_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "FacultyMemberGraduateProjectAllocation" (
    "id" TEXT NOT NULL,
    "topic_title" TEXT NOT NULL,
    ...
    CONSTRAINT "FacultyMemberGraduateProjectAllocation_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "DraftTopic" (
    "id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT,
    "field" TEXT NOT NULL,
    "sub_field" TEXT,
    "status" "DraftTopicStatusT" NOT NULL DEFAULT 'PENDING_ADVISOR',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "DraftTopic_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "DraftTopicComment" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "DraftTopicComment_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "TopicMember" (
    ...
    "desc_role" TEXT,
    "status" "TopicMemberStatus" NOT NULL DEFAULT 'PENDING',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ProjectResultFile" (
    ...
    "status" "ResultFileStatus" NOT NULL DEFAULT 'PENDING',
    "description" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "uploaded_by_id" TEXT,
...
CREATE TABLE "DefenseCommittee" (
    ...
    "status" "DefenseCommitteeStatus" NOT NULL DEFAULT 'SCHEDULED',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "created_by_id" TEXT NOT NULL,
...
CREATE TABLE "ProjectEvaluation" (
    ...
    "status" "EvaluationStatusType" NOT NULL,
...
-- CreateIndex
CREATE INDEX "LecturecPreferences_lecturer_id_topic_title_idx" ON "LecturecPreferences"("lecturer_id", "topic_title");

-- CreateIndex
CREATE INDEX "StudentAdvisorPreferences_student_id_faculty_member_id_pref_idx" ON "StudentAdvisorPreferences"("student_id", "faculty_member_id", "preferred_at");

-- CreateIndex
CREATE INDEX "FacultyMemberGraduateProjectAllocation_student_id_lecturer__idx" ON "FacultyMemberGraduateProjectAllocation"("student_id", "lecturer_id", "allocated_at");
...
-- AddForeignKey
ALTER TABLE "LecturecPreferences" ADD CONSTRAINT "LecturecPreferences_lecturer_id_fkey" FOREIGN KEY ("lecturer_id") REFERENCES "FacultyMembers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentAdvisorPreferences" ADD CONSTRAINT "StudentAdvisorPreferences_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Students"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentAdvisorPreferences" ADD CONSTRAINT "StudentAdvisorPreferences_faculty_member_id_fkey" FOREIGN KEY ("faculty_member_id") REFERENCES "FacultyMembers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FacultyMemberGraduateProjectAllocation" ADD CONSTRAINT "FacultyMemberGraduateProjectAllocation_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Students"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FacultyMemberGraduateProjectAllocation" ADD CONSTRAINT "FacultyMemberGraduateProjectAllocation_lecturer_id_fkey" FOREIGN KEY ("lecturer_id") REFERENCES "FacultyMembers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DraftTopic" ADD CONSTRAINT "DraftTopic_proposal_outline_id_fkey" FOREIGN KEY ("proposal_outline_id") REFERENCES "ProposalOutline"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DraftTopic" ADD CONSTRAINT "fk_draft_topic_student" FOREIGN KEY ("creator_id") REFERENCES "Students"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DraftTopic" ADD CONSTRAINT "fk_draft_topic_faculty" FOREIGN KEY ("creator_id") REFERENCES "FacultyMembers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DraftTopic" ADD CONSTRAINT "DraftTopic_approved_by_id_fkey" FOREIGN KEY ("approved_by_id") REFERENCES "FacultyMembers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DraftTopicComment" ADD CONSTRAINT "DraftTopicComment_study_topic_darf_id_fkey" FOREIGN KEY ("study_topic_darf_id") REFERENCES "DraftTopic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TopicMember" ADD CONSTRAINT "fk_topic_member_draft_topic" FOREIGN KEY ("topic_id") REFERENCES "DraftTopic"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
