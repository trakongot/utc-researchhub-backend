...
CREATE TABLE "project_evaluation_score" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "project_evaluation_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "audit_log_user_id_department_id_created_at_idx" ON "audit_log"("user_id", "department_id", "created_at");
...
-- AddForeignKey
ALTER TABLE "project_evaluation_score" ADD CONSTRAINT "project_evaluation_score_project_evaluation_id_fkey" FOREIGN KEY ("project_evaluation_id") REFERENCES "project_evaluation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
