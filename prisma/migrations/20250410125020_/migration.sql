...
-- CreateEnum
CREATE TYPE "ProjectReportFileStatusT" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'WARNING', 'DEADLINE', 'TASK_ASSIGNED', 'COMMENT_MENTION', 'PROPOSAL_STATUS_CHANGE', 'OUTLINE_STATUS_CHANGE', 'REVISION_REQUEST', 'GRADE_AVAILABLE', 'MEETING_SCHEDULED', 'SYSTEM_UPDATE');
...
CREATE TABLE "project_report_file" (
    ...
    "status" "ProjectReportFileStatusT" NOT NULL DEFAULT 'PENDING',
    "description" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "uploaded_by_id" TEXT,
...
CREATE TABLE "project_evaluation" (
    ...
    "teacher_weight" DOUBLE PRECISION DEFAULT 0.5,
...
-- CreateIndex
CREATE INDEX "project_proposal_outline_id_status_idx" ON "project"("proposal_outline_id", "status");
...
-- CreateIndex
CREATE INDEX "project_comment_commenter_id_role_idx" ON "project_comment"("commenter_id", "role");
...
-- CreateIndex
CREATE INDEX "project_report_file_uploaded_by_id_uploaded_by_type_idx" ON "project_report_file"("uploaded_by_id", "uploaded_by_type");
...
-- CreateIndex
CREATE UNIQUE INDEX "project_criteria_score_project_eval_id_criteria_id_evaluato_key" ON "project_criteria_score"("project_eval_id", "criteria_id", "evaluator_id");

-- CreateIndex
CREATE INDEX "audit_log_entity_type_entity_id_created_at_idx" ON "audit_log"("entity_type", "entity_id", "created_at");

-- CreateIndex
CREATE INDEX "audit_log_user_id_user_type_created_at_idx" ON "audit_log"("user_id", "user_type", "created_at");

-- CreateIndex
CREATE INDEX "audit_log_action_created_at_idx" ON "audit_log"("action", "created_at");

-- CreateIndex
CREATE INDEX "notification_recipient_id_recipient_type_is_read_created_at_idx" ON "notification"("recipient_id", "recipient_type", "is_read", "created_at");
...
-- AddForeignKey
ALTER TABLE "proposed_project" ADD CONSTRAINT "fk_proposed_project_student" FOREIGN KEY ("created_by_id") REFERENCES "student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "proposed_project" ADD CONSTRAINT "fk_proposed_project_faculty" FOREIGN KEY ("created_by_id") REFERENCES "faculty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "proposed_project_comment" ADD CONSTRAINT "proposed_project_comment_project_darf_id_fkey" FOREIGN KEY ("project_darf_id") REFERENCES "proposed_project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "project_member" ADD CONSTRAINT "fk_topic_member_project" FOREIGN KEY ("topic_id") REFERENCES "project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "project_member" ADD CONSTRAINT "fk_topic_member_proposed_project" FOREIGN KEY ("topic_id") REFERENCES "proposed_project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "project_criteria_score" ADD CONSTRAINT "project_criteria_score_project_eval_id_fkey" FOREIGN KEY ("project_eval_id") REFERENCES "project_evaluation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "audit_log" ADD CONSTRAINT "fk_log_student" FOREIGN KEY ("user_id") REFERENCES "student"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "audit_log" ADD CONSTRAINT "fk_log_faculty" FOREIGN KEY ("user_id") REFERENCES "faculty"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_recipient_student_fkey" FOREIGN KEY ("recipient_id") REFERENCES "student"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_recipient_faculty_fkey" FOREIGN KEY ("recipient_id") REFERENCES "faculty"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_sender_student_fkey" FOREIGN KEY ("sender_id") REFERENCES "student"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_sender_faculty_fkey" FOREIGN KEY ("sender_id") REFERENCES "faculty"("id") ON DELETE SET NULL ON UPDATE CASCADE;
