...
export const facultyMemberGraduateProjectAllocationSchema = z.object({
  id: z.string().uuid(ErrInvalidUUID('ID')),

  topicTitle: z.string().min(3, ErrMinLength('Tiêu đề đề tài', 3)),

  allocatedAt: z.date({ invalid_type_error: ErrInvalidDate('Ngày phân công') }),
...
export type FacultyMemberGraduateProjectAllocation = z.infer<
  typeof facultyMemberGraduateProjectAllocationSchema
>;
